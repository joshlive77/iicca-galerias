            ...
            <div class="imagen-chica">
                    ...
                    <div class="popup" id="popup-2">
                        <div class="popup-inner">
                            <div class="popup__photo">
                                <img src="https://iicca.edu.bo/wp-content/uploads/2019/09/3.jpg" alt="">
                            </div>
                ...
                <div class="imagen">
                    ...
                    <div class="popup" id="popup-3">
                        <div class="popup-inner">
                            <div class="popup__photo">
                                <img src="https://iicca.edu.bo/wp-content/uploads/2019/09/2.jpg" alt="">
                            </div>
                            <!-- <div class="popup__text">
                                <h1>Lorem ipsum dolor sit amet</h1>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ex velit, viverra non vulputate vitae, blandit vitae nisl. Nullam fermentum orci et erat viverra bibendum. Aliquam sed varius nibh, vitae mattis purus. Mauris elementum sapien non ullamcorper vulputate. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed eget felis sit amet eros viverra pulvinar.</p>
                ...
                <div class="imagen">
                    ...
                    <div class="popup" id="popup-4">
                        <div class="popup-inner">
                            <div class="popup__photo">
                                <img src="https://iicca.edu.bo/wp-content/uploads/2019/09/1.jpg" alt="">
                            </div>
                            <!-- <div class="popup__text">
                                <h1>Lorem ipsum dolor sit amet</h1>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ex velit, viverra non vulputate vitae, blandit vitae nisl. Nullam fermentum orci et erat viverra bibendum. Aliquam sed varius nibh, vitae mattis purus. Mauris elementum sapien non ullamcorper vulputate. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed eget felis sit amet eros viverra pulvinar.</p>
                ...
                <div class="imagen">
                    <img src="https://iicca.edu.bo/wp-content/uploads/2019/09/5.jpg">
                    <a class="modal" href="#popup-4">
                        <p></p>
                    </a>
                    <div class="popup" id="popup-4">
                        <div class="popup-inner">
                            <div class="popup__photo">
                                <img src="https://iicca.edu.bo/wp-content/uploads/2019/09/5.jpg" alt="">
                            </div>
                            <!-- <div class="popup__text">
                                <h1>Lorem ipsum dolor sit amet</h1>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ex velit, viverra non vulputate vitae, blandit vitae nisl. Nullam fermentum orci et erat viverra bibendum. Aliquam sed varius nibh, vitae mattis purus. Mauris elementum sapien non ullamcorper vulputate. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed eget felis sit amet eros viverra pulvinar.</p>
